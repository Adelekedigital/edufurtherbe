...
@router.get(
    ...
    description=(
        ...
        "bookable product.\n\n"
        "`meeting_venue` is already resolved — an offering without its own "
        "venue inherits the mentor's, and a client never has to know that "
        "cascade exists. The meeting link itself is generated per session and "
        "never appears here.\n\n"

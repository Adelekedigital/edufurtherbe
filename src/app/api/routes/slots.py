...
@router.get(
    ...
    description=(
        ...
        "carries `min_notice_minutes` — two hours by default — and anything "
        "starting sooner than that is not offered. Nothing in the past is "
        "offered either, whatever the range asked for.\n\n"
